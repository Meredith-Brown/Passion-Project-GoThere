  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="passionprojectApp.tripLocation.home.createOrEditLabel" data-cy="TripLocationCreateUpdateHeading">
            <Translate contentKey="passionprojectApp.tripLocation.home.createOrEditLabel">Create or edit a TripLocation</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                name="location"
                data-cy="location"
                label={translate('passionprojectApp.tripLocation.location')}
                type="select"
              >
                <option value="" key="0" />
                {locations
              ...
              <ValidatedField
                ...
                name="trip"
                data-cy="trip"
                label={translate('passionprojectApp.tripLocation.trip')}
                type="select"
              >
                <option value="" key="0" />
                {trips
