...
export const TripLocationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="passionprojectApp.tripLocation.delete.question">
        <Translate contentKey="passionprojectApp.tripLocation.delete.question" interpolate={{ id: tripLocationEntity.id }}>
