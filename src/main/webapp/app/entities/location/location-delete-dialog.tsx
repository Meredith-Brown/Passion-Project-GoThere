...
export const LocationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="passionprojectApp.location.delete.question">
        <Translate contentKey="passionprojectApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
