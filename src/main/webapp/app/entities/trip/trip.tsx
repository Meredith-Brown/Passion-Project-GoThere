  ...
  return (
    <div>
      <h2 id="trip-heading" data-cy="TripHeading">
        <Translate contentKey="passionprojectApp.trip.home.title">Trips</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="passionprojectApp.trip.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/trip/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="passionprojectApp.trip.home.createLabel">Create new Trip</Translate>
          </Link>
        </div>
      </h2>
        ...
        {tripList && tripList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="passionprojectApp.trip.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="passionprojectApp.trip.startDate">Start Date</Translate>
                </th>
                <th>
                  <Translate contentKey="passionprojectApp.trip.endDate">End Date</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="passionprojectApp.trip.home.notFound">No Trips found</Translate>
            </div>
          )
        )}
      </div>
