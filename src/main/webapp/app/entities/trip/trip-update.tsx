  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="passionprojectApp.trip.home.createOrEditLabel" data-cy="TripCreateUpdateHeading">
            <Translate contentKey="passionprojectApp.trip.home.createOrEditLabel">Create or edit a Trip</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('passionprojectApp.trip.startDate')}
                id="trip-startDate"
                name="startDate"
                data-cy="startDate"
                type="date"
              ...
              />
              <ValidatedField
                label={translate('passionprojectApp.trip.endDate')}
                id="trip-endDate"
                name="endDate"
                data-cy="endDate"
                type="date"
